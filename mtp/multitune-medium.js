...
window.onload = function mtp() {
    ...
    var initnames = document.getElementById("multinames").innerHTML;
   ...
   // fill holes left by possible blank track titles
    ...
    xplay.onmouseover = function() { this.style.backgroundColorx = "#" + jscolor; }; 
    ...
    xskip.onmouseover = function() { this.style.backgroundColor = "#" + color; }; 
    xskip.onmouseout = function() { this.style.backgroundColor = "#ffffff"; }; 
