...
function generate() {
    ...
    document.getElementById("desc").innerHTML = "<b>First code:</b> Paste it where you want the player to be. Change the margin-top and margin-left numbers for exact positioning.<br><b>Second code:</b> Paste it just before /body (located near the end of your blog or website’s HTML)."
