...
// style player elements
    ...
    xplay.onmouseover = function() { this.style.opacity = "0.75"; };
    ...
    xpause.onmouseover = function() { this.style.opacity = "0.75"; };
    ...
    xskip.onmouseover = function() { this.style.opacity = "0.75"; };
